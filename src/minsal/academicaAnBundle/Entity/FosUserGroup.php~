...
class FosUserGroup
{
     ...
     * Add user
     *
     * @param \minsal\academicaAnBundle\Entity\FosUserUser $user
     * @return FosUserGroup
     */
    public function addUser(\minsal\academicaAnBundle\Entity\FosUserUser $user)
    {
        $this->user[] = $user;
     ...
     * @param \minsal\academicaAnBundle\Entity\FosUserUser $user
     */
    public function removeUser(\minsal\academicaAnBundle\Entity\FosUserUser $user)
    {
