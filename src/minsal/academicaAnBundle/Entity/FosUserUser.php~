...
class FosUserUser
{
     ...
     * Add group
     *
     * @param \minsal\academicaAnBundle\Entity\FosUserGroup $group
     * @return FosUserUser
     */
    public function addGroup(\minsal\academicaAnBundle\Entity\FosUserGroup $group)
    {
        $this->group[] = $group;
     ...
     * @param \minsal\academicaAnBundle\Entity\FosUserGroup $group
     */
    public function removeGroup(\minsal\academicaAnBundle\Entity\FosUserGroup $group)
    {
