...
use minsal\academicaAnBundle\Entity\Evaluacion;
use minsal\academicaAnBundle\Form\EvaluacionType;
...
class EvaluacionController extends Controller
{
     ...
     * @Method("POST")
     * @Template("minsalacademicaAnBundle:Evaluacion:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('minsalacademicaAnBundle:Evaluacion')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("minsalacademicaAnBundle:Evaluacion:edit.html.twig")
     */
